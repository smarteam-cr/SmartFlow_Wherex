function loadConfig(env = process.env) {
  ...
  const required = {
    ...
    HUBSPOT_TICKET_PIPELINE_ID: env.HUBSPOT_TICKET_PIPELINE_ID,
    HUBSPOT_TICKET_STAGE_NEW_ID: env.HUBSPOT_TICKET_STAGE_NEW_ID,
    HUBSPOT_TICKET_STAGE_CLOSED_ID: env.HUBSPOT_TICKET_STAGE_CLOSED_ID,
    HUBSPOT_APP_SECRET: env.HUBSPOT_APP_SECRET,
