...
beforeEach(() => {
  ...
  delete require.cache[require.resolve('../src/services/jira')];
...
describe('JiraService', () => {
  ...
  describe('searchIssues', () => {
    ...
    it('follows nextPageToken until null and concatenates issues', async () => {
      ...
      // Second call must carry nextPageToken from first response
  ...
  describe('respondToIssue', () => {
    it('adds comment and transitions when JIRA_TRANSITION_DONE_ID is set', async () => {
      fetchMock
