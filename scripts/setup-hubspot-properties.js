/**
 * Crea (si faltan) las propiedades custom jira_* en el objeto Tickets de HubSpot.
 * Necesarias para que src/modules/jira/jobs/ingest.js pueda crear/buscar tickets.
 *
 * Uso: node scripts/setup-hubspot-properties.js
 */
require('dotenv').config();

const TOKEN = process.env.JIRA_HUBSPOT_TOKEN;
...
async function diagnoseTickets() {
  if (!TOKEN) {
    console.log('JIRA_HUBSPOT_TOKEN no esta en .env');
    return false;
  }

  console.log('\n--- Diagnostico: acceso a Tickets ---');
